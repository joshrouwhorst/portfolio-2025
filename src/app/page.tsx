  ...
  return (
    <ScrollProvider>
      <div className="font-sans">
        ...
        >
          Built and deployed website using Progress Sitefinity CMS and hosted on
          Microsoft Azure. Implemented responsive, accessibility-minded
          templates and component-based content modules in Sitefinity;
          integrated third-party services and APIs for analytics, forms, and
          marketing; and configured CI/CD pipelines and Azure App Service for
          reliable, scalable hosting. Optimized performance with image and asset
          delivery strategies, implemented role-based content workflows, and
          ensured secure configuration and monitoring to meet enterprise
